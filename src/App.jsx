...
function App() {
  ...
  const frontPanelVariants = shouldReduceMotion
    ...
    : {
      ...
      open:   { y: isMobile ? 68 : 108, z: 10, scale: 0.997 },
      }
  ...
  const fileVariants = {
    ...
    open: (index) =>
      shouldReduceMotion
        ...
        : {
            y: isMobile ? (-10 - index * 14) : (-14 - index * 22),
            x: 0,
            opacity: 1,
            scale: 1,
            ...
            >
              ...
              <div className="absolute inset-[8%] flex flex-col justify-between overflow-hidden">
                ...
                >
                  ...
                  <span className="truncate text-[clamp(0.54rem,0.88vw,0.66rem)] uppercase tracking-[0.1em]">
                ...
                {/* Location */}
                <div className="flex min-w-0 items-center gap-[0.7em] text-amber-950/45">
                  <svg className="h-[clamp(10px,1.05vw,13px)] w-[clamp(10px,1.05vw,13px)] flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
